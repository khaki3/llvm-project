...
! Under -gpu=mem:managed, a dynamic automatic array is later moved to the heap
! and allocated with malloc_managed. Lowering only records the mode on the
! module; symbols stay unmarked (no cudaDataAttr).
